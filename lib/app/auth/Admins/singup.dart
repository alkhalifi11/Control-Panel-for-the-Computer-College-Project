// ignore_for_file: prefer_final_fields, prefer_const_constructors, use_build_context_synchronously, avoid_single_cascade_in_expression_statements, await_only_futures, sort_child_properties_last, non_constant_identifier_names, unused_import, unused_field
                  ...
                  child: ListView(
                    children: [
                      ...
                      CustTextForm(
                        ...
                        obscureText: false,
                        names: 'اسم المستخدم للحساب',
                        decision: false,
                      ),
                      CustTextForm(
                        valid: (val) {
                          return validInput(val!, 8, 255);
                        },
                        mycontroller: password,
                        obscureText: false,
                        names: 'كلمة المرور للحساب',
                        decision: false,
                      ),
                      SizedBox(
                        height: 20,
